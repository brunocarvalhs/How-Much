...
/**
 * Guards the `core.data` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.data"
    ...
    @Test
    fun `data package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
