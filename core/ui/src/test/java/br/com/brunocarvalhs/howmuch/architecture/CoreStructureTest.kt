...
/**
 * Guards the `core.ui` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.ui"
    ...
    @Test
    fun `ui package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
