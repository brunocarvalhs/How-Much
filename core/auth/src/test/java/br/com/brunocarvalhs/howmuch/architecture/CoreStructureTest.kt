...
/**
 * Guards the `core.auth` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.auth"
    ...
    @Test
    fun `auth package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
