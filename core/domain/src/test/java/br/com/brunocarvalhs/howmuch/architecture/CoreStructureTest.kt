...
/**
 * Guards the `core.domain` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.domain"
    ...
    @Test
    fun `domain package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
