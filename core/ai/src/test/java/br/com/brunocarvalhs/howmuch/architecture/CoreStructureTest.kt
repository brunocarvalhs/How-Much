...
/**
 * Guards the `core.ai` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.ai"
    ...
    @Test
    fun `ai package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
