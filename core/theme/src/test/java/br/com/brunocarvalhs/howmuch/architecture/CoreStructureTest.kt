...
/**
 * Guards the `core.theme` package against drifting away from the set of layer folders already
...
class CoreStructureTest {
    ...
    private val corePackage = "br.com.brunocarvalhs.howmuch.core.theme"
    ...
    @Test
    fun `theme package only contains the allowed core layers`() {
        Konsist
            .scopeFromProject()
            .files
