...
/**
 * Guards the `feature.settings` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.settings"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `settings package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
