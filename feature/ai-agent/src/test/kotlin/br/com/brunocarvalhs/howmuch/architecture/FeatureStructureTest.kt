...
/**
 * Guards the `feature.ai_agent` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.ai_agent"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `ai_agent package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
