...
/**
 * Guards the `feature.cart` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.cart"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `cart package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
