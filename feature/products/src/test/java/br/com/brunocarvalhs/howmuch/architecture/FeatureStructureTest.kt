...
/**
 * Guards the `feature.products` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.products"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `products package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
