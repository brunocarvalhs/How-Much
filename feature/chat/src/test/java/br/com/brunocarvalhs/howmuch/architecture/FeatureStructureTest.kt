...
/**
 * Guards the `feature.chat` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.chat"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `chat package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
