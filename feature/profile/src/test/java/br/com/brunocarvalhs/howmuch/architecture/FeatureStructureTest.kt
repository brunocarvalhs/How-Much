...
/**
 * Guards the `feature.profile` package against drifting away from the project's standard
...
class FeatureStructureTest {
    ...
    private val featurePackage = "br.com.brunocarvalhs.howmuch.feature.profile"
    private val allowedLayers = setOf("data", "di", "domain", "navigation", "presentation", "commons")

    @Test
    fun `profile package only contains the allowed feature layers`() {
        Konsist
            .scopeFromProject()
            .files
